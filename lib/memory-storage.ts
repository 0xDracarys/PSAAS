...
const sampleWebsiteSettings: MemoryWebsiteSettings[] = [
  {
    ...
    profile: {
      ...
      title: "Security Engineer & Bug Hunter",
      bio: "I work at the intersection of security and reliability. Currently at NordVPN handling technical escalations and networking issues. On the side, I hunt bugs on Bugcrowd and tinker with security tooling. I enjoy understanding how systems break so I can help make them better.",
