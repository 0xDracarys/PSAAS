...
export const defaultThemes: ThemeSettings[] = [
  ...
  },
  {
    ...
    layout: {
      ...
      shadows: {
        ...
        md: '0 4px 8px -2px rgba(14, 165, 233, 0.15)',
        lg: '0 10px 20px -5px rgba(14, 165, 233, 0.2)',
        xl: '0 20px 30px -8px rgba(14, 165, 233, 0.25)',
      },
    },
    components: {
  ...
  },
  {
    ...
    layout: {
      ...
      shadows: {
        ...
        md: '0 6px 12px -2px rgba(249, 115, 22, 0.15)',
        lg: '0 12px 24px -6px rgba(249, 115, 22, 0.2)',
        xl: '0 24px 36px -10px rgba(249, 115, 22, 0.25)',
      },
    },
    components: {
      button: { style: 'default', size: 'md', rounded: true },
  ...
  },
  {
    ...
    layout: {
      ...
      shadows: {
        ...
        md: '0 4px 8px -2px rgba(34, 197, 94, 0.15)',
        lg: '0 10px 20px -5px rgba(34, 197, 94, 0.2)',
        xl: '0 20px 30px -8px rgba(34, 197, 94, 0.25)',
      },
    },
    components: {
      button: { style: 'default', size: 'md', rounded: true },
      card: { style: 'glassmorphism', border: true, shadow: true },
      input: { style: 'glassmorphism', border: true },
    },
    animations: {
      enabled: true,
      duration: 'normal',
  ...
  },
  {
    ...
    layout: {
      ...
      shadows: {
        sm: '0 2px 4px 0 rgba(168, 85, 247, 0.15)',
        md: '0 6px 12px -2px rgba(168, 85, 247, 0.2)',
        lg: '0 12px 24px -6px rgba(168, 85, 247, 0.25)',
        xl: '0 24px 36px -10px rgba(168, 85, 247, 0.3)',
      },
    },
    components: {
      button: { style: 'default', size: 'md', rounded: true },
  ...
  {
    _id: 'theme_hackthebox',
    name: 'HackTheBox Hacker',
    isActive: false,
    colors: {
      primary: '#9fef00',
      secondary: '#a4b816',
    ...
    typography: {
      fontFamily: '"Courier New", "Ubuntu Mono", "Fira Code", monospace',
      fontSize: {
        xs: '0.75rem',
        sm: '0.875rem',
        base: '1rem',
    ...
    layout: {
      ...
      shadows: {
        sm: '0 1px 2px 0 rgba(159, 239, 0, 0.1)',
        md: '0 4px 6px -1px rgba(159, 239, 0, 0.15)',
        lg: '0 10px 15px -3px rgba(159, 239, 0, 0.2)',
        xl: '0 20px 25px -5px rgba(159, 239, 0, 0.25)',
      },
    },
    components: {
      button: { style: 'default', size: 'md', rounded: false },
      card: { style: 'default', border: true, shadow: true },
      input: { style: 'default', border: true },
    },
    animations: {
    ...
    customCSS: '/* HackTheBox terminal styling */\n.htb-terminal {\n  font-family: "Courier New", monospace;\n  text-shadow: 0 0 5px rgba(159, 239, 0, 0.5);\n}\n\n/* Cursor blink effect */\n@keyframes htb-blink {\n  0%, 50% { opacity: 1; }\n  51%, 100% { opacity: 0; }\n}\n\n.htb-cursor::after {\n  content: "█";\n  animation: htb-blink 1s step-end infinite;\n  color: #9fef00;\n}\n\n/* Scanline effect */\n@keyframes htb-scanline {\n  0% { transform: translateY(-100%); }\n  100% { transform: translateY(100%); }\n}\n\n.htb-scanline::before {\n  content: "";\n  position: absolute;\n  top: 0;\n  left: 0;\n  width: 100%;\n  height: 2px;\n  background: linear-gradient(transparent, rgba(159, 239, 0, 0.3), transparent);\n  animation: htb-scanline 8s linear infinite;\n  pointer-events: none;\n}',
    version: 1,
    createdAt: new Date(),
    updatedAt: new Date(),
  },
...
export class ThemeService {
  ...
  // Helper method to get default theme
  private static getDefaultTheme(): ThemeSettings {
