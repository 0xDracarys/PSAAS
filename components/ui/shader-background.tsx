...
interface ShaderBackgroundProps {
  ...
  intensity?: number; // 0-1, controls line brightness
}
...
const ShaderBackground: React.FC<ShaderBackgroundProps> = ({
  ...
  // Fragment shader source code - Modified to accept uniform colors
  const getFsSource = () => `
  ...
  useEffect(() => {
    ...
    const shaderProgram = initShaderProgram(gl, vsSource, getFsSource());
    ...
    const render = () => {
      ...
      // Set color uniforms with intensity
      gl.uniform4f(programInfo.uniformLocations.bgColor1, bgColor1.r, bgColor1.g, bgColor1.b, bgColor1.a);
      gl.uniform4f(programInfo.uniformLocations.bgColor2, bgColor2.r, bgColor2.g, bgColor2.b, bgColor2.a);
      gl.uniform4f(programInfo.uniformLocations.lineColor, lineColor.r * intensity, lineColor.g * intensity, lineColor.b * intensity, lineColor.a);
